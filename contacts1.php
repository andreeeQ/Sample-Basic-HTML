    ...
    <form action="" method="post" class="mb-3">
      <div class="select-block">
        <select name="burg">
          ...
          <option value="Regular Burger">Regular Burger ~~~~~~ $0.35</option>
          <option value="American Burger">American Burger ~~~~~~ $1.34</option>
          <option value="Egg Burger">Egg Burger ~~~~~~ $0.28</option>
          <option value="Hungarian Sandwich">Hungarian Sandwich ~~~~~~ $1.50</option>
          <option value="Kingcrab Burger">Kingcrab Burger ~~~~~~ $25.34</option>
		  <option value="Shrimp Burger">Shrimp Burger ~~~~~~ $20.34</option>
		  <option value="Burger Overload"> Burger Overload ~~~~~~ $30.34</option>
    ...
    <form action="" method="post" class="mb-3">
      <div class="select-block">
        <select name="burg1">
		  ...
		  <option value="4x">3x</option>
		  <option value="5x">3x</option>
   ...
   <input type="submit" name="submit" vlaue="Choose options">
	...
	<?php
      if(isset($_POST['submit'])){
        if(!empty($_POST['burg'])) {
          $selected = $_POST['burg'];
		  echo  nl2br("\nYou have ordered: "). $selected;
        } else {
          echo '  ';
        }
      }
   {
        if(!empty($_POST['burg1'])) {
          $selected = $_POST['burg1'];
		  echo  nl2br("\nQuantity: "). $selected;
        } else {
          echo ' '; 
        }
...
<div class="container">
  ...
  <center>  <h1>Contact Us</h1></center>
	...
	<label for="subject"><p>Concern</p></label>
	<textarea id="subject" name="subject" placeholder="Write your concern.." style="height"> </textarea>
	<center><input type="submit" value"submit"></center>
	
  <center>  <p>"Burgers made for Greatness"</p></center>
  </div>
</div>
